...
colors = [["#121212", "#121212"], # panel background
          ...
          ["#bbbbbb", "#bbbbbb"], # font color for group names
          ["#dfd460", "#dfd460"], # border line color for current tab
          ["#8700ff", "#8700ff"], # border line color for 'other tabs' and color for 'odd widgets'
