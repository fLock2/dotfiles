...
myShowWNameTheme = def
    { swn_font              = "xft:Iosevka:bold:size=0"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#073642"
    , swn_color             = "#93A1A1"
    }
...
myWorkspaces = ["WEBS", "NOTE", "DOCS", "SYST", "DEVS", "CHAT", "FREE", "VOLM", "MUSC"]
...
myManageHook = composeAll
     ...
     , className =? "Vivaldi"   --> doShift ( myWorkspaces !! 0 )
...
myKeys =
    ...
    -- KB_GROUP Windows navigation
        ...
        , ("M-S-d", rotSlavesDown)    -- Rotate all windows except master and keep focus in place
        , ("M-S-f", rotAllDown)       -- Rotate all the windows in the current stack
